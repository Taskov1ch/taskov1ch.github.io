			...
			<div className="max-w-5xl mx-auto">
				...
				>
					<div>
						...
						<h1 className="text-6xl font-sans font-bold text-main">
							{t("links.title")}
						</h1>
					</div>
					...
					{links.map((link, index) => {
						...
						return (
							<motion.a
								...
								whileTap={{ scale: 0.98 }}
								className="group relative bg-surface border border-muted/20 h-48 p-8 flex flex-col justify-between overflow-hidden neon-card-hover transition-all duration-300"
							>
								...
								<div className="absolute top-0 right-0 w-8 h-8 border-l border-b border-muted/20 bg-bg z-10 group-hover:bg-accent group-hover:border-black/10 transition-colors" />
							</motion.a>
						);
					})}
				</div>
